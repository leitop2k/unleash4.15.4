...
- **session** - The session config object takes the following options:
  - _ttlMinutes_ (number) - The number of minutes a user session is allowed to live before a new sign-in is required. Defaults to 30 minutes. `SESSION_TTL_MINUTES`
